                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="form-group mt-2">
                                        ...
                                        <input type="text" id="the_washer" class="form-control text-center" name="washer" oninput="this.value = this.value.replace(/[^\u0600-\u06FF\s\/\-_()\[\]]/g, '')" pattern="[\u0600-\u06FF\s\/\-_()\[\]]{3,}" placeholder="القائم بالغسل" required>
                                    ...
                                    <div class="form-group mt-2">
                                        ...
                                        <input type="text" id="the_carrier" class="form-control text-center" name="carrier" oninput="this.value = this.value.replace(/[^\u0600-\u06FF\s\/\-_()\[\]]/g, '')" pattern="[\u0600-\u06FF\s\/\-_()\[\]]{3,}" placeholder="القائم بالنقل" required>
