        ...
        <div class="col-12">
            ...
            <div class="content-data">
                <div class="row">
                    <div class="col-12">
                        <?php $k = 1 ?>
                        <table class="table borderd-table display align-middle text-center" id="table20" data-order='[[ 0, "asc" ]]' data-page-length='10'>
                            <thead>
                                <tr>
                                                ...
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="{{route('zenhom-deceased.update')}}" method="post" enctype="multipart/form-data">
                                                                @csrf
                                                                <div class="container-fluid">
                                                                    <div class="row">
                                            ...
                                            <div class="modal fade" id="delete{{$deceased->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="{{route('zenhom-deceased.destroy', $deceased->id)}}" method="get">
                                                                @csrf
                                                                <div class="container-fluid">
                                                                    <div class="row">
                                                                        <div class="col-12">
