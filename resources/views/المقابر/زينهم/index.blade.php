                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{route('zenhom.update')}}" method="post">
                                                        @csrf
                                                        <div class="container-fluid">
                                                            <div class="row">
                                    ...
                                    <div class="modal fade" id="delete{{$tomb->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{route('zenhom.destroy', $tomb->id)}}" method="get">
                                                        @csrf
                                                        <div class="container-fluid">
                                                            <div class="row">
                                                                <div class="col-12">
                                                                    ...
                                                                    @foreach ($tomb->rooms as $room)
                                                                        ...
                                                                        @if ($sumSize === $room->capacity)
                                                                            <tr>
                                                                                ...
                                                                                <td class="d-flex justify-content-center">
                                                                                    <a href="{{ route('zenhom.rooms', ['tombId' => $tomb->id, 'roomId' => $room->id]) }}" class="btn btn-info ms-2">
                                                                                        <i class="fa fa-eye"></i>
                                                                                    </a>
                                                                                    @if ($sumSize >= $room->capacity)
                                                                        ...
                                                                        @else
                                                                            <tr>
                                                                                ...
                                                                                @endif
                                                                                <td>
                                                                                    <a href="{{ route('zenhom.rooms', ['tombId' => $tomb->id, 'roomId' => $room->id]) }}" class="btn btn-info">
                                                                                        <i class="fa fa-eye"></i>
                                                                                    </a>
                                                                                    @php
