                    ...
                    <form action="{{route('tombs.store')}}" method="post" id="newTombForm">
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group mb-2">
                                        <input type="text" name="name" placeholder="إسم المقبرة" id="tombName" oninput="this.value = this.value.replace(/[^\u0600-\u06FF\s]/g, '')" pattern="[\u0600-\u06FF\s\d]{3,}" class="form-control text-center" required>
