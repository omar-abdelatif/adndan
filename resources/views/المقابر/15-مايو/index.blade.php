    ...
    <div class="row">
        <div class="col-12">
            ...
            @elseif ($errors->any())
                ...
                @endforeach
            @endif
            <table class="table borderd-table display align-middle text-center" id="table7" data-order='[[ 0, "asc" ]]' data-page-length='10'>
                <thead>
                    <tr>
                        ...
                        <td class="text-center">قيمة الدفع السنوي</td>
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{route('15may.update')}}" method="post">
                                                        @csrf
                                                        <div class="container-fluid">
                                                            <div class="row">
                                    ...
                                    <div class="modal fade" id="delete{{$tomb->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{route('15may.destroy', $tomb->id)}}" method="get">
                                                        @csrf
                                                        <div class="container-fluid">
                                                            <div class="row">
                                                                <div class="col-12">
                                                                            ...
                                                                            @if ($sumSize === $room->capacity)
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="d-flex justify-content-center">
                                                                                        <a href="{{ route('15may.rooms', ['tombId' => $tomb->id, 'roomId' => $room->id]) }}" class="btn btn-info ms-2">
                                                                                            <i class="fa fa-eye"></i>
                                                                                        </a>
                                                                                        @if ($sumSize >= $room->capacity)
